...
replace github.com/Postcord/rest => github.com/oscenbot/rest v0.0.6-0.20210819234046-5192739f2eec

require (
	github.com/Postcord/objects v0.0.12
	github.com/Postcord/rest v0.0.5
